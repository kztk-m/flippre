...
pprGrammar :: (Show c) => (forall f. (GrammarD c f) => f a) -> Doc ann
pprGrammar g = pretty $ freeze g

pprAsFlat :: (Show c) => (forall f. (GrammarD c f) => f a) -> Doc ann
pprAsFlat g = pretty $ flatten g
